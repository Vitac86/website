          ...
          <div className="hidden min-w-0 flex-1 items-center gap-3 rounded-xl border border-slate-200 bg-white/92 p-1.5 shadow-[0_14px_28px_-22px_rgba(15,36,57,0.9)] lg:flex">
            <nav aria-label="Основная навигация" className="shrink-0">
              <ul className="flex items-center gap-0.5">
                <HeaderNavLinks
                  links={navLinks}
                  linkClassName="inline-flex rounded-lg px-3 py-2 text-sm font-semibold text-slate-600 transition-all duration-300 hover:bg-slate-100 hover:text-brand"
                  activeClassName="bg-slate-100 text-brand"
                />
              </ul>
            </nav>
        ...
        <div className="mt-3 grid gap-3 lg:hidden">
          ...
          <div className="overflow-x-auto pb-1">
            <ul className="flex min-w-max items-center gap-1 rounded-lg border border-slate-200 bg-white p-1.5">
              <HeaderNavLinks
                links={navLinks}
                linkClassName="inline-flex rounded-md px-3 py-1.5 text-sm font-semibold text-slate-600 transition-colors hover:bg-slate-100 hover:text-brand"
                activeClassName="bg-slate-100 text-brand"
              />
            </ul>
          </div>
